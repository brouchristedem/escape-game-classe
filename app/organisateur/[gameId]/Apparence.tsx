...
export default function Apparence({ gameId }: { gameId: string }) {
  ...
  if (!charge) return <p className="text-slate-500 text-sm">Chargement...</p>;
  ...
  return (
    <section className="max-w-2xl">
      ...
      <div className="grid gap-6 sm:grid-cols-2 mb-6">
        <div className="bg-brand-blue-light rounded-xl p-4 flex flex-col gap-4">
          <label className="flex items-center justify-between gap-3 text-sm font-medium text-brand-navy">
            Couleur de fond
          ...
          {erreurCouleurs && <p className="text-sm text-red-600">{erreurCouleurs}</p>}
        </div>
        ...
        <div className="bg-brand-blue-light rounded-xl p-4 flex flex-col gap-3">
          ...
          />
          {logo && (
            <button onClick={() => setLogo("")} className="self-start text-sm underline text-brand-navy">
              Retirer le logo
            </button>
          )}
        </div>
      ...
      <p className="text-sm font-medium text-brand-navy mb-2">Aperçu</p>
      <div
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="rounded-full bg-brand-blue px-6 py-2 text-sm font-semibold text-white disabled:opacity-50"
        >
        ...
        <button
          ...
          className="rounded-full border border-slate-300 px-6 py-2 text-sm text-brand-navy disabled:opacity-50"
        >
